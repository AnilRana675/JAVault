...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Dark theme primary colors with neon accents
        primary: {
          50: '#f0f9ff',
          100: '#e0f2fe',
          200: '#bae6fd',
      ...
      boxShadow: {
        ...
        'dark': '0 10px 25px -5px rgba(0, 0, 0, 0.25), 0 4px 6px -2px rgba(0, 0, 0, 0.1)',
      ...
      backgroundImage: {
        ...
        'neon-gradient': 'linear-gradient(45deg, #00d4ff, #a855f7, #ec4899)',
      },
      transitionProperty: {
        'height': 'height',
